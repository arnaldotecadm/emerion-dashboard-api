    ...
    private fun ingestItem(item: IngestProductCommand, now: Instant): IngestItemResult {
        return try {
            ...
            val toSave = existing?.mergeFromIngestion(
                ...
                codigoBarrasProprio = item.codigoBarrasProprio,
                preco = item.preco,
                preco2 = item.preco2,
                preco3 = item.preco3,
                preco4 = item.preco4,
                ...
                estoqueAdquirido = item.estoqueAdquirido,
                estoqueAtual = item.estoqueAtual,
                estoqueRma = item.estoqueRma,
                similar = item.similar,
                quantidadeVolumes = item.quantidadeVolumes,
                quantidadeEmbalagem = item.quantidadeEmbalagem,
                localizacao = item.localizacao,
                cubagem = item.cubagem,
                codigoBarrasEmbalagem = item.codigoBarrasEmbalagem,
                ibsCClassTrib = item.ibsCClassTrib,
                ibsCst = item.ibsCst,
                fcpEntrada = item.fcpEntrada,
                fcpSaida = item.fcpSaida,
                ipiSaida = item.ipiSaida,
                ipiEntrada = item.ipiEntrada,
                icmSaida = item.icmSaida,
                icmEntrada = item.icmEntrada,
                icmStSaida = item.icmStSaida,
                icmStEntrada = item.icmStEntrada,
