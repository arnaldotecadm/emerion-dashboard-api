...
object CustomerOrderQueryRestMapper {
    ...
    fun toResponse(customerOrder: CustomerOrder): CustomerOrderResponse =
        CustomerOrderResponse(
            ...
            totfrt = customerOrder.totfrt,
            totseg = customerOrder.totseg,
            totoutdesp = customerOrder.totoutdesp,
            vendedorExternalId = customerOrder.vendedorExternalId,
            atendenteCod = customerOrder.atendenteCod,
            dataEntregaPrevista = customerOrder.dataEntregaPrevista,
            descontoComercial = customerOrder.descontoComercial,
            descontoRegional = customerOrder.descontoRegional,
            codigoTransportadora = customerOrder.codigoTransportadora,
            linhaReserva = customerOrder.linhaReserva,
